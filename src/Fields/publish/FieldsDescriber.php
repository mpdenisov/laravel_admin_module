<?php
namespace App\Modules\Admin\Fields;
...
class FieldsDescriber
{
    ...
    {
        return [
            'optional'        => trans('Admin::strings.optional'),
            'required'        => trans('Admin::strings.required'),
            'required|unique' => trans('Admin::strings.required_unique')
        ];
    }
    ...
    {
        return [
            'false' => trans('Admin::strings.default_unchecked'),
            'true'  => trans('Admin::strings.default_checked'),
        ];
    }
}