...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2">
            <h1>{{ trans('Admin::qa.menus-createCrud-create_new_crud') }}</h1>
    ...
    <div class="form-group">
        {!! Form::label('parent_id', trans('Admin::qa.menus-createCrud-crud_parent'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('singular_name', trans('Admin::qa.menus-createCrud-crud_singular_name'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('plural_name', trans('Admin::qa.menus-createCrud-crud_plural_name'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('title', trans('Admin::qa.menus-createCrud-crud_title'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('roles', trans('Admin::qa.menus-createCrud-roles'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('soft', trans('Admin::qa.menus-createCrud-soft_delete'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('icon', trans('Admin::qa.menus-createCrud-icon'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
